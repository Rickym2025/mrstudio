      ...
      <ul className="flex gap-2 bg-black/60 backdrop-blur-xl p-2 rounded-full border border-white/10 shadow-2xl">
        {menuItems.map((item, idx) => (
          ...
          >
            ...
            <span className="absolute left-12 text-white text-[14px] font-bold uppercase tracking-wider opacity-0 group-hover:opacity-100 transition-all whitespace-nowrap">
              {item.title}
            </span>
          </li>
        ))}
